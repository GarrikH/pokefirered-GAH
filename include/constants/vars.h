...
// i am assuming these are unused
...
#define VAR_0x40FE 0x40FE // this will be a var for trigger leaving pallet town -- note this flag also works for if we should allow the player to leave the monastery.
#define GOOD_PTS 0x40FF   // let's use this as our social score
